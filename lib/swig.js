 ...
 *
 * Copyright (c) 2020-2021 Øistein Sørensen
...
swig.setFilter('escapeEmail', utilHtml.escapeEmail);
swig.setFilter('age', utilHtml.age);
swig.setFilter('secToHms', utilHtml.secToHms);
swig.setFilter('formatDistance', utilHtml.formatDistance);
